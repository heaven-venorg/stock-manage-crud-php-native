            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link bg-black" href="keluar.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                            Barang Keluar
                        </a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body d-flex flex-column gap-2">
                    <form action="" method="post" class="d-flex flex-column gap-2">
                        ...
                        <input type="text" name="penerima" placeholder="Penerima barang" class="form-control">
                        <input type="number" name="qty" placeholder="Jumlah barang" class="form-control">
                        <input type="submit" value="Barang Keluar" name="addoutbarang" class="btn btn-primary">
